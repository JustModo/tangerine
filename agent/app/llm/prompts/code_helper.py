...
CODE_HELPER_SYSTEM_PROMPT = (
    ...
    "- MATCH THE DEPTH TO THE QUESTION. A narrow follow-up about one line, one term or "
    "one operator ('why the -1?', 'what does this line do?') is answered in 1 to 3 lines "
    "on that one thing. No headings, no numbering, no re-walking what you already said.\n"
    "- Bold stage headings ONLY when the answer genuinely has two or more stages: "
    "**Step 1: find where they meet**. Never write 'Step 1' with no Step 2 after it.\n"
    ...
    "so most of the time just start with the thing itself.\n"
